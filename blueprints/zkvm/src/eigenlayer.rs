...
use eigensdk_rs::zkvm_avs::operator::*;
use sp_core::Pair;
...
sol!(
    ...
    #[sol(rpc)]
    ZkvmTaskManager,
    "contracts/out/ZkvmTaskManager.sol/ZkvmTaskManager.json"
);
...
//     event_handler(
//         protocol = "eigenlayer",
//         instance = ZkvmTaskManager,
//         event = ZkvmTaskManager::NewTaskCreated,
//         event_converter = convert_event_to_inputs,
//         callback = ZkvmTaskManager::ZkvmTaskManagerCalls::respondToTask
//     ),
// )]
...
pub fn convert_event_to_inputs(event: ZkvmTaskManager::NewTaskCreated) -> (U256, u32, Bytes, u32) {
...
//             zkvm_service_manager_addr: Default::default(),
...
//             topics: vec!["__TESTING_zkvm".to_string()],
...
//         // };
//         //
//         // let contract: ZkvmTaskManager::ZkvmTaskManagerInstance = ZkvmTaskManager::ZkvmTaskManagerInstance::new(contract_address, provider);
//         //
//         // EventWatcher::run(
